(() => {
  ...
  root.innerHTML = `
    <style>
      ...
      .nx-foot{padding:9px 13px 11px;border-top:1px solid #ffffff14;background:#05080e2e}.nx-composer{position:relative;isolation:isolate;display:grid;grid-template-columns:minmax(0,1fr) 30px;align-items:center;gap:5px;padding:4px;border:1px solid #dfe4ec26;border-radius:24px;background:#ffffff05;backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);transition:border-color .70s ease-in-out,box-shadow .70s ease-in-out}.nx-composer:before,.nx-composer:after{content:"";position:absolute;z-index:-1;inset:-1.5px;padding:1.5px;border-radius:inherit;background:conic-gradient(from var(--nx-angle),#2edbff,#4df08f,#ff8fa3,#ff334d,#ff8fa3,#9e66ff,#2edbff);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask-composite:exclude;opacity:0;pointer-events:none;animation:nx-ring 5.2s linear infinite;animation-play-state:paused;transition:opacity .70s ease-in-out}.nx-composer:after{inset:-6px;padding:4px;filter:blur(8px);opacity:0}.nx-composer[data-active="true"]{border-color:transparent;box-shadow:0 0 22px #788dff20;transition-duration:.55s}.nx-composer[data-active="true"]:before{opacity:1;animation-play-state:running;transition-duration:.55s}.nx-composer[data-active="true"]:after{opacity:.2;animation-play-state:running;transition-duration:.55s}.nx-composer textarea{width:100%;min-height:28px;max-height:88px;padding:5px 8px 4px;resize:none;border:0;outline:0;color:#f5f6f9;background:transparent;font-size:13px;line-height:1.3}.nx-composer textarea::placeholder{color:#ffffff57}.nx-composer button{align-self:center;display:grid;place-items:center;width:28px;height:28px;padding:0;border:1px solid #ffffff1f;border-radius:50%;color:#fff;background:#ffffff12;cursor:pointer}.nx-composer button:disabled{opacity:.4}.nx-fine{display:flex;justify-content:space-between;margin:7px 3px 0;color:#ffffff45;font-size:6px;font-weight:760;letter-spacing:.09em;text-transform:uppercase}
      @media(max-width:600px){
        ...
        .nx-composer textarea{font-size:17px!important;line-height:1.2;-webkit-appearance:none;appearance:none;touch-action:manipulation}
